...
new function () { // closure
    ...
    var ComponentModel = Base.extend({
        constructor: function () {
            ...
            this.extend({
                ...
                getDependencyMap: function () { return _dependencyMap; },
                getDependencies: function (key) { 
                    return _dependencyMap[key || $constructor];
                },
                setDependencies: function (key, value) {
                    ...
                    _dependencyMap[key || $constructor] = Array2.map(value, DependencyModel);
                },
    ...
    function _makeClassFactory(clazz) {
        return function (dependencies) {
            return clazz.new.apply(clazz, dependencies[$constructor]);
        }
    }
    ...
    function _makeProxyFactory(types) {
        ...
        return function (dependencies) {
            var args         = dependencies[$constructor] || [],
            ...
            this.extend({
                ...
                registerHandler: function(componentModel) {
                    var key           = componentModel.getKey(),
                        ...
                        dependencyMap = componentModel.getDependencyMap(),
