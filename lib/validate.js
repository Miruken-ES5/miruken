...
new function () { // closure
    ...
    var ValidationCallbackHandler = CallbackHandler.extend({
        validate: function (object, scope) {
            ...
            return Q.when($composer.deferAll(validation), function (handled) {
                return !handled || validation.isValid() ? validation : Q.reject(validation);
            });
        }
    });
	...
	define("miruken.validate", [], function() {
	    return validate;
	});
    }
