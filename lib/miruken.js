...
new function () { // closure
    ...
    var Delegate = Base.extend({
         ...
         * @return  {Any}      the result of the proxied get.
         */
         ...
         * @param   {Boolean}  strict      - true if target must adopt protocol
         * @return  {Any}      the result of the proxied invocation.
         */
    ...
    var ObjectDelegate = Delegate.extend({
         ...
         * @param  {String}      propertyName    - definition
         * @param  {Boolean}     strict          - definition
         ...
         * @param  {Protocol}    protocol        - definition
         * @param  {String}      propertyName    - definition
         * @param  {String}      propertyValue   - definition
         * @param  {Boolean}     strict          - definition
         * @return {Object}      object          - definition
         */
        set: function (protocol, propertyName, propertyValue, strict) {
         ...
         * @method invoke
         * @param  {Protocol}    protocol        - definition
         * @param  {String}      methodName      - definition
         * @param  {Array}       args            - definition
         * @param  {Boolean}     strict          - definition
     ...
     * @return   {Boolean} true if a protocol.
     */
     ...
     * @return   {Boolean} true if a class (and not a protocol).
     */
     ...
     * @return   {Boolean} true if a promise. 
     */
     ...
     * @return   {Boolean} true if value not null or undefined.
     */
     ...
     * @method $isNothing
     * @param    {Any}     value  - value to test
     * @return   {Boolean} true if value null or undefined.
     */
