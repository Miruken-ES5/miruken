...
new function () { // closure
    ...
    var miruken = new base2.Package(this, {
        name:    "miruken",
        version: "1.0",
        exports: "Protocol,Proxy,Disposing,DisposingMixin,Parenting,TraversingAxis,Traversing,TraversingMixin,Traversal,Variance,Modifier,IndexedList,$isProtocol,$isClass,$classOf,$ancestorOf,$isString,$isFunction,$isPromise,$isSomething,$isNothing,$using,$lift,$eq,$use,$copy,$lazy,$eval,$child,$optional,$promise,$createModifier"
    });
        ...
        init: function () {
            ...
            Base.extend = function () {
                ...
                return (function (base, args) {
                    ...
                    while (args.length > 0) {
                        var arg = args[0];
                        if (arg.prototype instanceof Protocol) {
                            protocols.push(args.shift());
                        } else if (arg.prototype instanceof Module) {
    ...
    /**
     * @class {IndexedList}
     * Maintains a simple doublely-linked list with indexing capability.
     */
