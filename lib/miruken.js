...
new function () { // closure
    ...
    var miruken = new base2.Package(this, {
        name:    "miruken",
        version: "1.0",
        exports: "Protocol,Proxy,Disposing,DisposingMixin,Parenting,TraversingAxis,Traversing,TraversingMixin,Traversal,Variance,Modifier,$isProtocol,$using,$isClass,$isFunction,$isPromise,$isSomething,$isNothing,$lift,$eq,$use,$copy,$lazy,$eval,$child,$optional,$promise,$createModifier"
    });
