...
new function () { // closure
    ...
    var ioc = new base2.Package(this, {
        ...
        exports: "Container,Registration,ComponentPolicy,Lifestyle,TransientLifestyle,SingletonLifestyle,ContextualLifestyle,ComponentModel,IoContainer,DependencyManager,DependencyResolution,DependencyResolutionError,$$composer,$ioc"
    });
   ...
   /**
    ...
    function _registerHandler(container, componentModel) {
        var key          = componentModel.getKey(),
            ...
            return lifestyle.resolve(
                _activateInstance.bind(container, clazz, factory, dependencies, resolution, composer),
                composer
            );
    ...
    function _activateInstance(clazz, factory, dependencies, resolution, composer) {
        var promises      = [],
            parameters    = [],
        ...
        for (var index = 0; index < dependencies.length; ++index) {
            var dependency   = dependencies[index],
                ...
                ioc          = modified && $ioc.test(dependency),
                ...
                invariant    = modified && $eq.test(dependency);
