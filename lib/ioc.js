...
new function () { // closure
    ...
    var ioc = new base2.Package(this, {
        ...
        exports: "Container,Registration,ComponentPolicy,Lifestyle,TransientLifestyle,SingletonLifestyle,ContextualLifestyle,DependencyModifiers,DependencyModel,DependencyManager,ComponentModel,IoContainer,DependencyResolution,DependencyResolutionError,$$composer,$ioc"
    });
    ...
    var DependencyModel = Base.extend({
        ...
        promote: function (dependency) {
            if ((dependency === undefined) ||(dependency instanceof DependencyModel)) {
                return dependency;
            }
            ...
            this.extend({
                ...
                setIndex: function (index, dependency) {
                    if ((dependencies.length <= index) ||
                        ...
                        dependencies[index] = DependencyModel.promote(dependency);
                    }
                    return this;
                },
                insertIndex: function (index, dependency) {
                    dependencies.splice(index, 0, DependencyModel.promote(dependency));
                    return this;
                },
                ...
                append: function (/* dependencies */) {
                    var deps = Array2.flatten(arguments).map(function (dependency) {
                        return DependencyModel.promote(dependency);
                    });
            ...
            this.extend({
                ...
                setLifestyle: function (value) {
                    if (!$isSomething(value) && !(value instanceof Lifestyle)) {
                        throw new TypeError(lang.format("%1 does not extend Lifestyle.", value));
                    }
                    _lifestyle = value; 
                },
                getFactory: function () {
                ...
                setDependencies: function (value) {
                    ...
                    _dependencies = Array2.map(value, function (dependency) {
                        return DependencyModel.promote(dependency);
                    });
                },
   ...
   /**
    ...
    function _activate(clazz, factory, dependencies, resolution, composer) {
		...
		parameters[index] = undefined;
            ...
            if (use || dynamic || $isNothing(dependency)) {
                ...
                var optional  = dep.test(DependencyModifiers.Optional),
                    ioc       = dep.test(DependencyModifiers.Container),
                ...
                if (lazy) {
                    dependency = (function (paramDep, created, param) {
                        return function () {
                            if (!created) {
                                created = true;
                                var container = ioc ? containerDep : composer;
                    ...
                    var paramDep  = new DependencyResolution(dependency, resolution),
                        container = ioc ? containerDep : composer;
        ...
        function createInstance () {
            return factory.apply(undefined, parameters);
        }
